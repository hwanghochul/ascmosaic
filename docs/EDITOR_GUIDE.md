...
#### 밝기 범위 (Brightness Range)

셀 밝기 측정 시 사용할 밝기 범위를 설정합니다.

**밝기 범위 그룹:**
- 밝기 범위 설정은 밝은 회색 박스로 그룹화되어 있습니다
- 두 슬라이더를 함께 사용하여 밝기 범위를 조정합니다
...
- **범위**: 0 ~ 100
- **효과**: 
  - 값이 작을수록 어두운 부분이 더 어둡게 표시됩니다
  - 값이 클수록 어두운 부분도 상대적으로 밝게 표시됩니다
...
- **범위**: 0 ~ 100
- **효과**: 
  - 값이 작을수록 밝은 부분도 상대적으로 어둡게 표시됩니다
  - 값이 클수록 밝은 부분이 더 밝게 표시됩니다

**사용 예시:**
- 최소 밝기 20, 최대 밝기 80: 일반적인 밝기 범위 (기본값)
- 최소 밝기 0, 최대 밝기 100: 전체 밝기 범위 사용
- 최소 밝기 40, 최대 밝기 60: 좁은 밝기 범위로 대비 강조
...
- 도형 및 텍스처 설정
- 컨트롤 모드 설정
- ASCII 모자이크 필터 설정 (회피하기, 세트변경, 밝기 범위, 안티알리아싱 포함)
